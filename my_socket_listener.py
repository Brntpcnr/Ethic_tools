...
class SocketListener:
    def __init__(self,ip,port): # self command is a keyword that forms a connection between the instance and the class
    ...
    def save_file(self,path,content):
        with open(path,"wb") as my_file: # wb = write as binary
    ...
    def start_listener(self):
        while True:
            ...
            command_input = command_input.split(" ") # this split means that whatever you see in this bracket, split it to the lines according to it, here our split is the space between words
            try:
